...
export default class ProjectsMenu extends Component {
    ...
    render() {
        ...
        const projectItems = ["LLM Dissertation", "AR Quantum", "Selection Hyperheuristic", "MORE TO BE ADDED"]

        return (
            <div className="project-menu"> 
                <div className ="project-items-container">
                    {projectItems.map((item, index) => (
                        <div key={index} className={classNames("project-item", {activeProject: activeProject === index + 1,
                        })}
